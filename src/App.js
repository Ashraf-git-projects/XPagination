...
function App() {
  ...
  // ✅ Pagination Calculations (safe default)
    ...
    <div className="App">
      <div className='pagination_content'>
        ...
        <div className="button_group">
          <button className='btns' onClick={handlePrevious} disabled={currentPage === 1}>
            Previous
          </button>
          
          {/* ✅ current page shown clearly */}
          <span className='btns'>{currentPage}</span>
          
          <button className='btns' onClick={handleNext} disabled={currentPage === totalPages}>
            Next
          </button>
        </div>
      </div>
